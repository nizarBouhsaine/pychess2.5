...
# Dictionnaire des pieces
PIECES = ["bR", "bN", "bB", "bQ", "bK", "bP", "wR", "wN", "wB", "wQ", "wK", "wP"]

"""Les fonctions"""


# fonction qui associe les images aux pièces correspondentes
def load_images(img):
    for piece in PIECES:
...
def high_light_King(window, gs):
    ...
    if gs.inCheck:
        ...
        # s.set_alpha(180)  # la case est plus transparente quand la valeur est plus petite
...
def end_game_text(window, text):
    ...
    # FONT = p.font.Font(None, 40)
    # TEXT = FONT.render("A to Return to the menu", True, p.Color("Black"))
